    ...
    function (lang, declare, parser, BaseWidget, On, Dom) {
        ...
        return declare([BaseWidget], {
            ...
            InitDatePicker: function () {
                ...
                var FromDay = new Date(nowday - 1000 * 3600 * 24 * 6);

                var FD = Dom.byId("FromDate"); //DateOfTable
                FD.min = "2015-04-08";
                FD.max = max;
                FD.value = this.GetDateString(FromDay);
            ...
            StartPredicting: function () {
                ...
                //预测方法
                PageMethods.GetPredictionResult(this.datatype, Dom.byId("FromDate").value, Dom.byId("ToDate").value, Dom.byId("Location").value, Dom.byId("PDays").value,
                    function (e) {
