...
define([
    ...
    function (declare, _WidgetsInTemplateMixin, BaseWidget, domConstruct, domStyle,
        ...
        var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
            ...
            newestTableName:"",
            firstPlu: "--",//首要污染物
            PM_TENtops: [6, 35, 97, 160, 222, 284, 324, 361, 200, 406],
            PM_TENgrades: [0, 15, 30, 45, 60, 75, 90, 150, 200, 250],
            COtops: [6, 36, 74, 114, 152, 193, 251, 291, 328, 349, 368, 386, 406],
            COgrades: [0, 0.2, 0.4, 0.6, 0.8, 1, 2, 4, 6, 7, 8, 9, 10],
            NO_TWOtops: [0, 55, 95, 139, 178, 222, 263, 303, 345, 386, 406],
            NO_TWOgrades: [0, 15, 25, 35, 45, 60, 80, 100, 120, 140, 150],
            O_THRtops: [0, 34, 82, 116, 146, 177, 211, 261, 308, 342, 375, 406],
            O_THRgrades: [0, 10, 30, 40, 60, 80, 100, 130, 160, 180, 200, 300],
            SO_TWOtops: [0, 37, 64, 91, 116, 146, 174, 201, 228, 256, 283, 311, 351, 379, 406],
            SO_TWOgrades: [0, 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 30, 45, 60, 100],
            PM_HFtops: [0, 63, 131, 199, 267, 337, 361, 382, 406],
            ...
            AddLayer: function (e) {
                ...
                if (loadLayer == undefined) {
                    ...
                    domStyle.set(loadLayer, { "background-color": "black", "opacity": "0.9", "position": "absolute", "width": "330px", "height": "600px", "background-image": "url('images/loading3.gif')", "background-position": "center", "background-repeat": "no-repeat" });
                ...
                dojo.xhrGet({
                    ...
                    load: function (response, ioArgs) {
                        ...
                        var params = {
                            ...
                            "DatatableName": this.newestTableName
                        };
                        gp.submitJob(
                            params,
                            function (jobInfo) {
            ...
            ValuePointer: function (type) {
                ...
                results[1] = results[1] * (this.tops[index] + this.tops[index - 1]);
                return results;
            }
        });
