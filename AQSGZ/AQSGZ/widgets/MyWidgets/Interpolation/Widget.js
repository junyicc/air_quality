    ...
    function (lang, declare, Parser, BaseWidget, On, domStyle, domAttr, domClass, Dom, Geoprocessor, esriConfig, ImageParameters, Graphic, FeatureSet, Draw, SimpleFillSymbol, domConstruct) {
        ...
        return declare([BaseWidget], {
            ...
            startup: function () {
                ...
                esriConfig.defaults.InterpolationPanel = this;
            },
            ...
            onClose: function () {
                if (esriConfig.defaults.drawTool != null) {
                ...
                $(".jimu-widget-Interpolation #OK").css("display", "none");
                $(".jimu-widget-Interpolation #ChaZhi_gzs").css("display", "none");
                $(".jimu-widget-Interpolation #ChaZhi_szx").css("display", "none");
                $(".jimu-widget-Interpolation .Methods span").removeClass("selected");
                $(".jimu-widget-Interpolation .Loading").remove();
            },
            ...
            InitDatePicker: function () {
                ...
                PageMethods.GetNewestTableName(
                    function (e) {
                        ...
                        max = esriConfig.defaults.InterpolationPanel.GetDateString(lastDate);
                        var FD = Dom.byId("SelectDate"); //DateOfTable
                        FD.min = "2015-04-08";
                        FD.max = max;
                        FD.value = max;
                    });
            ...
            GetResult_Basic: function () {
                ...
                this.GetResultFormGP(DatabaseName, DatatableName, DataType, this.ChaZhi_szx);
            },
            ...
            GetResultFormGP: function (DatabaseName, DatatableName, DataType,IfMask) {
                            ...
                            dojo.xhrGet({
                                ...
                                load: function (response, ioArgs) {
                                    ...
                                    if (IfMask) {
                                        switch (DataType) {
                                            case "AQI":
                                                gpLink = response['AQI_Kriging']; break;
                                            case "PM25":
                                                gpLink = response['PM25_Kriging']; break;
                                            case "PM10":
                                                gpLink = response['PM10_Kriging']; break;
                                            case "CO":
                                                gpLink = response['CO_Kriging']; break;
                                            case "NO2":
                                                gpLink = response['NO2_Kriging']; break;
                                            case "O3_1":
                                            case "O3_8":
                                                gpLink = response['O3_Kriging']; break;
                                            case "SO2":
                                                gpLink = response['SO2_Kriging']; break;
                                            default:
                                                gpLink = response['AQI_Kriging']; break;
                                        }
                                    }
            ...
            AddGraphic: function (evt) {
                ...
                dojo.xhrGet({
                    ...
                    load: function (response, ioArgs) {
                        ...
                        var DatatableName = "DT_" + SelectYear + "_" + SelectMonth + "_" + SelectDay;
                        DatatableName += esriConfig.defaults.InterpolationWidget.StaticData ? "" : "_"+esriConfig.defaults.InterpolationWidget.GetSelectHour();
            ...
            SelectMethod: function (e) {
                ...
                switch (selectId) {
                    case "ChaZhi":
                        $("#ChaZhi_gzs").slideToggle(200);
                        $("#ChaZhi_szx").slideToggle(200);
                        break;
                    case "ChaZhi_gzs":
                        this.ChaZhi_gzs = true;
                        this.ChaZhi_szx = false;
                        ...
                        break;
                    case "ChaZhi_szx":
                        this.ChaZhi_gzs = false;
                        this.ChaZhi_szx = true;
                        this.DengZhiXian = false;
                        this.ZiDingYi = false;
                        this.Remove = false;
                        $(".jimu-widget-Interpolation #OK").show(500);
                    ...
                    case "ZiDingYi":
                        ...
                        this.ZiDingYi = true;
                        this.Remove = false;
                        $("#ChaZhi_gzs").slideUp(200);
                        $("#ChaZhi_szx").slideUp(200);
                        $(".jimu-widget-Interpolation #OK").show(500);
                        break;
                    case "Remove":
                        this.ChaZhi_gzs = false;
            ...
            Excute: function () {
                if (esriConfig.defaults.drawTool != undefined && esriConfig.defaults.drawTool != null) {
                    esriConfig.defaults.drawTool.deactivate();
                }
                if (this.ChaZhi_gzs||this.ChaZhi_szx) {
                    this.ShowWaitting();
                    if (this.StaticData) {
