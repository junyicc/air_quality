    ...
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      _changeStatus: function() {
        ...
        if (html.hasClass(this.domNode, 'jimu-widget-splash-desktop')) {
          ...
          html.setStyle(this.customContentNode, 'height', '170px');
      ...
      close: function () {
          html.setStyle(this.Zone, "-webkit-animation", "OuttoRight 0.5s forwards");
          html.setStyle(this.airQuality, "-webkit-animation", "OuttoLeft 0.5s 0s forwards");
          html.setStyle(this.welcomeLogo, "-webkit-animation", "OuttoLeft 0.5s 0.5s forwards");
          html.setStyle(this.GZmap, "-webkit-animation", "OutFade 1s forwards ");
          html.setStyle(this.domNode, "-webkit-animation", "OutFade 1s forwards");
          var dd = this.domNode;
          setTimeout(function () { $(dd).css("display", "none"); }, 800);    
      },

      settingPage: function () {

          var logo = this.airlogo;
          var timenow = this.TIMENOW;
          PageMethods.GetNewestWholeData(function (e) {

              var AQInum = e[0][2];

              if (AQInum >= 0 && AQInum < 50) {
                  $(logo).attr("src", "widgets/MyWidgets/splash/images/You.png");
              }
              else if (AQInum < 100) {
                  $(logo).attr("src", "widgets/MyWidgets/splash/images/Liang.png");
              }
              else if (AQInum < 150) {
                  $(logo).attr("src", "widgets/MyWidgets/splash/images/Qing.png");
              }
              else if (AQInum < 200) {
                  $(logo).attr("src", "widgets/MyWidgets/splash/images/Zhong1.png");
              }
              else if (AQInum < 250) {
                  $(logo).attr("src", "widgets/MyWidgets/splash/images/Zhong2.png");
              }
              else if (AQInum < 300) {
                  $(logo).attr("src", "widgets/MyWidgets/splash/images/Yan.png");
              }
              else {
                  $(logo).attr("src", "widgets/MyWidgets/splash/images/none.png");
              }
              $(timenow).html(e[2]);
